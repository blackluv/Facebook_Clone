    ...
    <div class="col-sm-4" id="down">
            <div class="row" id="white-box">
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th id="SanFran"><p id="fb-text"><?=ucwords($user['user']['first_name'].' '.$user['user']['last_name'])?></p></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="conainer">
                <div class="row">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <td id="white-box-friends" class="title">Your Friends</td>
                        ...
                        <?php
                            foreach ($user['friends'] as $friends) { ?>
                                <tr>
                                    <td id="white-box"><?= '<a href="/main/show/'.$friends['friend_id'].'"><p id="fb-text">'.$friends['first_name']." ".$friends['last_name'].'</p></a><br>'; ?></td>
                                    <td id="white-box"><?= '<a href="/main/delete_friend/'.$friends['friend_id'].'"><button class="btn pull-right" id="fb-button">Delete Friend</button></a>'; ?></td>
                                </tr>
                            <?php }  ?>
                        </tbody>
                    </table>
